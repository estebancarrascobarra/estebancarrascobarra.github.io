...
const translations = {
  es: {
    ...
    "hero.eyebrow": "Física teórica · Modelación matemática",
    ...
    "hero.supportValue": "Beca Nacional ANID",
    ...
    "background.item2Detail": "Marie Curie Staff Exchange · Modelación de incendios forestales",
    ...
    "footer.tagline": "Física teórica · Modelación matemática",
    "contact.eyebrow": "Mensaje privado",
    "contact.title": "Contacto",
    "contact.intro": "Este formulario envía el mensaje sin publicar mi dirección de correo en el sitio.",
    "contact.name": "Nombre",
  ...
  en: {
    ...
    "background.item2Detail": "Marie Curie Staff Exchange · Wildfire modelling",
    ...
    "contact.intro": "This form sends your message without publishing my email address on the website.",
    "contact.name": "Name",
